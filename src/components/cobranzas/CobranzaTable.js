        ...
        <div className="overflow-x-auto">
            <table className="w-full min-w-[780px] text-left">
                ...
                <tbody className="divide-y divide-slate-100 text-sm">
                    {collections.map((collection) => <tr key={collection.id} className="transition-colors hover:bg-blue-50/40">
                        ...
                        <td className="px-6 py-4"><CobranzaStatusBadge status={collection.estado} /></td>
